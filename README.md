...
So, for now forget everything just **listen to the** ![\Large f(x,y)=$\frac{sin(10(x^2+y^2))}{10}](https://latex.codecogs.com/svg.latex?\Large&space;STORY). Suppose you live in USA and your friend live in DELHI in India.You want to visit to your friend's house. You have no information how to reach there. So initially you have the information that some how you have to reach to India. Now suppose you land in Mumbai(another city of India).
